...
<table border="2" width="100%" align="left">
	...
	<tr height="400">
		<td colspan="2" align="center">
			<img src="<%=result%>" style="width:500px; height:350px; align="center">
		</td>
	</tr>
	<% }else{ %>
	<tr height="400">
...
<table border="0" width="50%" align="center">
	<tr>
		...
		<td width="30%"align="center">
			<font size="4"><b>正常に実行されました！</b></font>
		</td>
	</tr>
</table>
</br>
...
<table border="0" width="50%" align="center">
	<tr>
		...
		<td width="30%"align="center">
			<font size="4"><b>残念、実行されませんでした！</b></font>
		</td>
	</tr>
</table>
<% } %>
...
<table border="0" width="50%" align="center">
	<tr>
		...
		<td width="30%"align="center">
			<a href="/MonchiMainPage?flag=1">トップへ戻る</a>
		</td>
	</tr>
</table>
</form>
